...
class DeepQNetwork(nn.Module):
    def __init__(self, ALPHA) -> None:
        ...
        self.conv2 = nn.Conv2d(32, 6, 4, stride=2)
...
class Agent(object):
    def __init__(self, gamma, epsilon, alpha, maxMemorySize,
    ...
    def learn(self, batch_size):
        ...
        Qnext = self.Q_next.forward(list(memory[:, 3][:])).to(self.Q_eval.device) # if 2 gpu, change device
